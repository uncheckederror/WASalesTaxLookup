...
namespace WaRateFiles.Standardizer
{
    ...
    /// </summary>
    internal class AddressLineTokenizer
    {
        private string m_rawStreet;
        ...
        public AddressToken StreetType
        {
            ...
            private set { m_streetType = value; m_streetType.NormalizeRoadType(); m_streetType.ResultToken = StreetToken.STREETTYPE; }
        }

        public AddressToken SuffixDir
        {
            get { return m_sufdir; }
            private set { m_sufdir = value; m_sufdir.NormalizeDirectional(); m_sufdir.ResultToken = StreetToken.SUFDIR; }
        }
        ...
        public void Init(string street)
        {
            m_house = null;
            m_predir = null;
            m_street = null;
